...
public class SimpleCsvLogger {
    ...
    String output_dir = Config.usbLogFolder; // USB drive is mounted to /U on roboRIO
     ...
     * directory and writes the initial lines to it.
     * 
     * This constructor has no unit row.
     * 
     * @param data_fields  A set of strings for signal names to write into the file
     * @return 0 on successful log open, -1 on failure
     */
    public int init(String loggingDataIdentifier, String[] data_fields) {
